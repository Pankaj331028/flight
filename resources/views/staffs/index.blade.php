	...
	<div class="content-wrapper">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">Staffs</h3> </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if (Helper::checkAccess(route('createStaff')))
                            <div class="dt-buttons float-right">
                                <a href="{{route('createStaff')}}" class="btn dt-button">Add Staff</a>
                            </div>
                        @endif
                        <div class="table-responsive m-t-40">
                            ...
                            @if (Helper::checkAccess(route('changeStatusStaffs')))
                                <div class="dt-buttons">
                                    <a href="javascript:void(0)" data-href="{{route('changeStatusStaffs')}}" class="btn btn-secondary disabled bulkAction changeStatusStaffs">Activate/Deactivate</a>
                                </div>
                            @endif
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-valide" method="post" id="blockForm" action="{{route('changeStatusStaff')}}">
                        {{csrf_field()}}
                        <input type="hidden" name="statusid" id="statusid">
                        <input type="hidden" name="status" id="status">
                        <h5 class="m-t-10 text-danger">Are you sure you want to <span class="staffstatus"></span> staff : <span id="statuscode"></span></h5>
    ...
    <div class="modal fade" id="confirmDeleteModal" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-valide" method="post" id="deleteForm" action="{{route('deleteStaff')}}">
                        {{csrf_field()}}
                        <input type="hidden" name="deleteid" id="deleteid">
                        <h5 class="m-t-10 text-danger">Are you sure you want to delete staff : <span id="val-code"></span></h5>
                        <button type="button" class="btn btn-secondary btn-flat cancelBtn m-b-30 m-t-30" data-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-info btn-flat confirmBtn m-b-30 m-t-30">Confirm</button>
                    </form>
                </div>
    ...
    <script type="text/javascript">
    	$(function(){
    		var table = $('#staffsTable').DataTable({
                ...
                @if(Helper::checkAccess('admin/staffs/report'))
		        dom: 'Bfrtip',
                buttons: [
            ...
            $(document).on('click','input[name="user_ids[]"]',function(){
                ...
                if(length > 0)
                {
                    ...
                    $('.changeStatusStaffs').removeClass('disabled');
                    table.rows().select();
                }else{
                    // $('.deleteUsers').addClass('disabled');
                    $('.changeStatusStaffs').addClass('disabled');
                    table.rows().deselect();
                }
            });
            ...
            $(document).on('switchChange.bootstrapSwitch', '.statusStaff', function (event, state) {
                var x;
                ...
                $.ajax({
                    type: "post",
                    url: "{{route('changeStatusAjaxStaff')}}",
