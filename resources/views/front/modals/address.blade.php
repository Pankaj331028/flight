    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="updateAddress" method="Put" action="{{ url('api/updateUserAddress') }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <input type="text" name="mobile" class="form-control height50" placeholder="Contact No*" maxlength="10" minlength="10">
 ...
 --}}
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                     ...
                     <div class="form-group col-md-6">
                        <input type="text" name="zipcode" class="form-control height50" placeholder="Zip Code*" maxlength="6">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body m-10">
                <form method="POST" action="{{ url('update-address') }}">
                    ...
                    <input type="hidden" name="user_id" value="{{ $auth_user->id }}">
                    <input type="hidden" name="user_id" value="{{ $auth_user->id }}">
                    <input type="hidden" name="cart_id" value="{{isset($cart_id)?$cart_id:0 }}">

                    @if($user->user_addresses()->where('status', 'AC')->exists() && count($user->user_addresses) > 0)
                    @foreach($user->user_addresses()->where('status', 'AC')->get() as $user_address)
                    <div class="row">
                        <div class="col-md-12">
                            <div class="custom-control custom-checkbox mb-3">
                            <input type="radio" @if(isset($cart_address->id) && $cart_address->id==$user_address->id) checked @endif id="adrss-{{ $user_address->id }}" class="custom-control-input" name="address_id" value="{{ $user_address->id }}">
