                        ...
                        <div class="col-md-8 col-sm-8 col-8 d-flex pl-0">
                            <div class="cartProdDetail mb-md-0 mb-3 d-flex border-right-0 text-left w-100">
                                <div class="col-md-12 p-0">
                                    ...
                                    <span data-testid="new-price">{{ $currency }}{{ $variant->price }}</span></p>
                                    @else
                                    <p class="font16 color20 fontsemibold mb-1 d-flex align-items-center" data-testid="new-price">
                                    <span data-testid="new-price">{{ $currency }}{{ $variant->special_price }}</span>
                                    <strike class="colorb7 ml-2" data-testid="old-price">{{ $currency }} {{ $variant->price }}</strike>
                                    </p>
                                    @endif
