						    ...
						    <div class="row justify-content-center">
					            <div class="seccess-box text-center">
					            	...
					            	<div class="text-center sucess-pop-button mt-5">
						            	<button onclick='window.location="{{route('travel')}}"' class="btn filter_btn">Go To Home</button>
						            	<button onclick='window.location="{{route('my-bookings')}}"' class="btn filter_btn">My Booking</button>
						            </div>
					            </div>
						    </div>
						</div>
