            ...
            <div class="black_overlay">
                <div class="container mb-5">
                    <div class="cPadding">
                        ...
                        <div class="fliter_box_inner displayFlight px-4 mb-4 mt-4">
                            <div class="row">
                                <div class="col-lg-12">
                    ...
                    <div class="wizard">
                        <div class="wizard-inner">
                            ...
                            <ul class="nav nav-pills nav-wizard" id="tabs">
                                ...
                                <li class="disabled liStep6">
                                    <a href="#step-6" data-toggle="tab" id="step6"><span>6</span>Payment</a>
                                </li>
                            </ul>
                            <form method="POST" action="{{route('booking-confirmed')}}" class="checkout-form" id="passengerform" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <input type="hidden" name="totelPassngerId" id="totelPassngerId" value="">
                                <div class="tab-content">
                                                                        ...
                                                                        <div class="mb-3 pt-2 row">
                                                                            ...
                                                                            <div class="col-lg-9">
                                                                                <div class="row w-auto">
                                                                                    <div class="smallScreen col-lg-3 col-sm-10">
                                                                                        Preffered Class:
                                                                                    </div>
                                                                                    <div class="smallScreen col-lg-3 col-sm-4">
                                                    ...
                                                    <div class="form-in filters-results">
                                                        ...
                                                        <div>
                                                            <div class="row px-3">
                                                                ...
                                                                <div class="inout-control col-md-12 smallScreen">
                                                                    <div class="mb-3 pt-2">
                                            ...
                                            <div class="col-md-12">
                                                <div class="">
                                                    ...
                                                    <div class="form-in filters-results">
                                                        <div>
                                                            <div class="row px-3">
                                                                ...
                                                                <div class="inout-control col-md-4">
                                                                    <div class="input-group form-group mb-3">
                                                                        <input class="form-control h-100" type="text" id="numberbagsId" name="numberbags" placeholder="No. of Bags">
                                                                    </div>
                                                                </div>
                                                                <div class="inout-control col-md-4 ">
                                                                    <div class="input-group form-group mb-3">
                                                        ...
                                                        <div class="pBookHotel form-in">
                                                            ...
                                                            <div class="row px-3">
                                                                <div class="inout-control col-md-4 position-relative">
                                                                    <div class="input-group form-group mb-2 inputBorder span-0" style="height:46px;">
                                                                        <span class="input-group-addon"><i class="fa fa-map-marker location" aria-hidden="true"></i></span>
                                                                        <select name="state" id="state" class="form-control selectpicker border-0 hotelfieldChange h-100">
                                                                ...
                                                                <div class="inout-control col-md-4 position-relative">
                                                                    <div class="input-group form-group mb-2 inputBorder span-0" style="height:46px;">
                                                                        <span class="input-group-addon"><i class="fa fa-map-marker location" aria-hidden="true"></i></span>
                                                                        <select name="city" id="city" class="form-control selectpicker select2 hotelfieldChange h-100">
                                                                            <option value="">Select City *</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="inout-control col-md-4 position-relative roomType">
                                                                    <div class="input-group form-group room-height mb-2 inputBorder" style="height:46px;">
                                                                        <span class="input-group-addon"><i class="fa fa-bed bed" aria-hidden="true"></i></span>
                                                                        <select name="room_type[]" id="room_type" class="form-control selectpicker select2 hotelfieldChange h-100" multiple="multiple" placeholder="Select Room Type" data-placeholder="Select Room Type">
                                                                ...
                                                                <div class="inout-control col-md-4">
                                                                    <div class="input-group form-group mb-2 date inputBorder" data-date-format="mm-dd-yyyy">
                                                                        <span class="input-group-addon"><i class="fa fa-heart calendar" aria-hidden="true"></i></span>
                                                                        <input class="form-control from hotelfieldChange border-0" type="text" name="check_in" placeholder="Check-In --/--/-- *" readonly />
                                                                    </div>
                                                                </div>
                                                                <div class="inout-control col-md-4">
                                                                    <div class="input-group form-group mb-2 date inputBorder" data-date-format="mm-dd-yyyy">
                                                                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar calendar"></i></span>
                                                                        <input class="form-control to hotelfieldChange border-0" type="text" name="check_out" placeholder="Check-Out --/--/-- *" readonly />
                                                                    </div>
                                                                </div>
                                                                <div class="inout-control col-md-4">
                                                                    <div class="input-group form-group mb-2 inputBorder">
                                                                        <span class="input-group-addon"><i class="fa fa-bed gate" aria-hidden="true"></i></span>
                                                                        <select name="no_rooms" id="no_rooms" class="form-control selectpicker hotelfieldChange border-0 px-1 font15">
                                                                ...
                                                                <div class="inout-control col-md-4">
                                                                    <div class="input-group form-group mb-2 inputBorder">
                                                                        ...
                                                                        <select name="no_adults" id="no_adults" class="form-control selectpicker hotelfieldChange border-0 px-1 font15">
                                                                ...
                                                                <div class="inout-control col-md-4">
                                                                    <div class="input-group form-group mb-2 inputBorder">
                                                                        ...
                                                                        <input name="no_child" id="no_child" class="form-control font15 border-0 px-1" placeholder="No. Of Children border-0"  type="number" min="0" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="inout-control col-md-4 mb-4 position-relative  hotelDiv d-none">
                                                                <div class="input-group form-group mb-2" style="height:46px;">
                                                                    <span class="input-group-addon"><i class="fa fa-bed bed" aria-hidden="true"></i></span>
                                                                    <select class="hotel_name" name="hotel_name" id="hotel_name" class="form-control  border-0" style="width: 85%">
                                                    ...
                                                    <div class="row px-3 mt-3 checkout-next">
                                                        ...
                                                        <!-- <button type="button" id="step3next" class="stepbtn btn filter_btn" >Next</button> -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="step-4">
                                        <div class="row explore-hotels hotelWithFlight mt-5">
                                                <div class="col-md-12">
                                                    <div class="">
                                                        <div class="form-in filters-results">
                                                            <div class=" px-3">
                                                            ...
                                                            <div class="col-lg-3 position-relative float-right px-1 ml-auto pb-4">
                                                                <div class="h-auto depart">
                                                                    <button type="button" class="greenTransparentBtn mr-auto w-100" id='add_itinerary_row'>Add</button>
                                                                </div>
                                                            </div>
                                                            <!-- <div class="inout-control col-md-12 radio-button pb-3">
                                                                <b class="font16">Add Meals</b>
                                                            </div> -->
                                                            <section class="mealOuter pt-3">
                                                                <table class="table table-striped table-hover table-bordered">
                                                                    <thead>
                                                                        <tr>
                                                                            <th scope="col">Meals</th>
                                                                            @for($i =1 ;$i <=Request::get('passenger') ;$i++)
                                                                            <th scope="col">Passanger {{$i}}</th>
                                                                            @endfor
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody class="border" style="background-color:#f9f9f9;">
                                                                        <tr>
                                                                            <td>
                                                                                <ol type="1" class="pl-3">
                                                                                    @foreach($getMeals as $getMealsDetails)
                                                                                    <li>{{ $getMealsDetails['mealName']}}</li>
                                                                                    @endforeach
                                                                                </ol>
                                                                            </td>
                                                                            @for($i =1 ;$i <=Request::get('passenger') ;$i++)
                                                                            <td class="align-middle droppable">
                                                                                <div class="mealDroppable">
                                                                                    <ul class="pl-3 ">
                                                            ...
                                                            <div class="inout-control col-md-12 radio-button pb-3">
                                                                <b class="font16">Select Car</b>
                                                            </div>
                                                            <div class="row ">
                                                                    <div class="inout-control col-md-6">
                                                                        <div class="input-group form-group mb-3">
                                                                            <select class="form-control car_name" name="car_name[]"  id="car_name" multiple>
                                                                                <!-- <option value="">Select Car</option> -->
                                                                                @foreach($getCars as $getCarsDetails)
                                                                                <option value="{{$getCarsDetails['carName']}}" >{{$getCarsDetails['carName']}}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="row explore-hotels mt-5">
                                                <div class="col-md-12">
                                                    <div class="">
                                                        <div class="form-in">
                                                            <div class="row mx-auto">
                                                                <input type="hidden" name="flightCount" id="flightCount" value="{{count($getTrip['airlineRoutesEntity'])}}">
                                                            @foreach($getTrip['airlineRoutesEntity'] as $dataKey => $seatDetails)
                                                                <input type="hidden" name="flightSeatingRoutId[]" id="flightSeatingRoutId" value="{{$seatDetails['routeIds']}}">
                                                                <div class="col-lg-6">
                                                                    <div class="SelectPlaneSeat">
                                                                        <div class="selected-seats text-start px-4 py-3 font16">
                                                                            {{$flightNameArray[$seatDetails['fromlocation']] .'-'.$flightNameArray[$seatDetails['tolocation']]}} <br>
                                                                            Selected Seats:
                                                                            <span class="font14 " id="showTheSeat_{{$dataKey}}"></span>
                                                                        </div>
                                                                        <div class="p-4 fixHeight" id="cScrollBar">
                                                                            <div class="planeFront">
                                                                                <!-- <img src="{{asset('front/images/plane-front.png')}}" alt=""> -->
                                                                            </div>
                                                                            <div class="planeDesign p-4">
                                                                                    ...
                                                                                    foreach ($seatStatus as $seat) {
                                                                                        list($number, $alphabet) = explode('|', $seat);
                                                                                        $numberArray[] = $number;
                                                                                        $alphabetArray[] = $alphabet;
                                                                                        $seatStatusArray[$number] = $alphabet;
                                                                                    }

                                                                                    $numbers = [];
                                                                                    $alphabets = [];
                                                                                    foreach ($numberArray as $seat) {
                                                                                        $numberCount = substr($seat, 0, -1);
                                                                                        $alphabets = substr($seat, -1);

                                                                                        $numbers[] = $numberCount;
                                                                                        $alphabetsArray[] = $alphabets;
                                                                                    }

                                                                                    @endphp
                                                                                    @foreach(array_unique($numbers) as $seatNumber)
                                                                                    <div class="row mx-auto airplane">
                                                                                        @foreach(array_unique($alphabetsArray) as $alphabetsSeat)
                                                                                            @php
                                                                                            $seatStatus = $seatNumber . $alphabetsSeat;
                                                                                            @endphp
                                                                                        @if($seatStatusArray[$seatStatus] == 'Available')
                                                                                        <label class="seat">
                                                                                            <input type="checkbox" id="seat_number{{$dataKey.$seatNumber . $alphabetsSeat}}" name="seat_number[{{$dataKey}}][]" value="{{$seatNumber . $alphabetsSeat}}" class="seatNumberClass" />
                                                                                            <span>{{$seatNumber . $alphabetsSeat}}</span>
                                                                                        </label>
                                                                                        @else
                                                                                        <label class="seat seatSold">
                                                                                            <input type="checkbox" id="seat_number{{$dataKey.$seatNumber . $alphabetsSeat}}" name="seat_number[{{$dataKey}}][]" value="{{$seatNumber . $alphabetsSeat}}" class=" " disabled />
                                                                                            <span>{{$seatNumber . $alphabetsSeat}}</span>
                                                                                        </label>
                                                                                        @endif
                                                                            ...
                                                                            <div class="planeBack">
                                                                                <!-- <img src="{{asset('front/images/plane-back.png')}}" alt=""> -->
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row px-3 mt-3 checkout-next">
                                                            ...
                                                            <button type="button" id="step5next" class="stepbtn btn filter_btn">Next</button>
                                        ...
                                        <div class="row explore-hotels mt-5">
                                                <div class="col-md-12">
                                                    ...
                                                    <div style="float: right;">
                                                        The payment session will expire in: <h6 id="countdown" style="display: inline-block; margin: 0;"></h6>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row align-items-center justify-content-between mt-3 mb-3 checkout-prise">
                                                            <h5>Total Payment</h5>
                                                            <h2 class="totelFlightPrice">{{$currency}}</h2>
                                                        </div>
                                                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.validator.addMethod("invalidUpi", function(value, element, param) {
			    return ($.inArray(value, param) >= 0);
			}, function() {
			    return "Invalid UPI ID"
		});

        $.validator.addMethod("invalidCard", function(value, element, param) {
                    ...
                    for (var i = 0; i < formDataArray.length; i++) {
                        $.ajax({
                            ...
                            success: function (data) {
                                passengerIds.push(data);
                                // console.log(data);
                                // alert('pagganger');
                                $('#totelPassngerId').val(passengerIds);
                                // alert(passengerIds);
                            },
        ...
        $('#step2next').on('click', function (e) {
            if($('.checkout-form').valid()){
                ...
                var totelPassngerId = $('input[name="totelPassngerId"]').val();
                // alert(totelPassngerId);
                if(gst){
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        totelPassngerId:totelPassngerId,
                    },
                    success:function(data){
                        console.log(data);
        ...
        $('#hotelconfirm').on('click', function (e) {
            ...
            if($('.checkout-form').valid()){
                ...
                var no_rooms = $("input[name=no_rooms]").val();
        ...
        $('.droppable').droppable({
            ...
            drop: function(event, ui) {
                ...
                var droppedMeal = ui.helper.text();


                $(this).find('ul').append('<li class="w100 mealDataGet text-left">' + droppedMeal + '<span class="pl-3 cursor cancelMeal">&#xd7;</span></li>');

            }
        });

        $('.droppable').on('click', '.cancelMeal', function() {
        ...
        $('#step4next').on('click', function (e) {
            if($('.checkout-form').valid()){
                ...
                var mealsByPassenger = [];
                $('.mealDataGet').each(function(index, element) {

                    var currentText = $(element).text();
                    var modifiedText = currentText.slice(0, -1);

                    var existingIndex = mealsByPassenger.findIndex(function(item) {
                        return item.text === modifiedText;
                    });

                    if (existingIndex !== -1) {
                        mealsByPassenger[existingIndex].count++;
                    } else {
                        mealsByPassenger.push({
                            text: modifiedText,
                            count: 1
                        });
                    }
                ...
                var itinerary_name = $('select[name^=itinerary_name]').map(function(idx, elem) {
                       return $(elem).find('option:selected').text();
                }).get();
        ...
        $(document).on('change', '.seatNumberClass', function() {
            var isChecked = $(this).prop('checked');
            var nameAttribute = $(this).attr('name');
            var replacethenumber = nameAttribute.replace('seat_number[', '').replace('][]', '');

            if (isChecked) {
                $(this).parent().addClass('seatBooked');
                if (!selectedSeatsArray.hasOwnProperty(replacethenumber)) {
                    selectedSeatsArray[replacethenumber] = [];
                }
                selectedSeatsArray[replacethenumber].push($(this).val());
            } else {
                $(this).parent().removeClass('seatBooked');
                if (selectedSeatsArray.hasOwnProperty(replacethenumber)) {
                    var checkboxValue = $(this).val().toLowerCase();
                    selectedSeatsArray[replacethenumber] = selectedSeatsArray[replacethenumber].filter(function(value) {
                        return value.toLowerCase() !== checkboxValue;
                    });
                }


            }
            var flightCount = $('#flightCount').val();
            var selectedSeatsCount = Object.keys(selectedSeatsArray).length;


            var allSeatsSelected = true;
            $.each(selectedSeatsArray, function(index, value) {
                if (value.length != totelPassenger ) {
                    allSeatsSelected = false;
                }
                if(selectedSeatsCount != flightCount){
                    allSeatsSelected = false;
                }
                if (value.length == totelPassenger) {
                    $('#showTheSeat_' + index).text(value.join(', '));
                    $('input[name="seat_number[' + index + '][]"]').not(':checked').prop('disabled', true)
                } else {
                    $('input[name="seat_number[' + index + '][]"]').prop('disabled', false);
                    $('#showTheSeat_' + index).text(value.join(', '));
                }

            });

            // $("#submitBtn").prop('disabled', !allSeatsSelected || selectedSeatsCount != flightCount);
            $("#step5next").prop('disabled', !allSeatsSelected);
        });
        ...
        $("#step5next").on('click', function (e) {
            ...
            if($('.checkout-form').valid()){
                ...
                var flightSeatingRoutId = $('input[name^=flightSeatingRoutId]').map(function(idx, elem) {
                    return $(elem).val();
                }).get();
                console.log(flightSeatingRoutId);

                var seat_numberArray = [];
                for(var i = 0;i < flightCount;i++){
                       var seat_number =  $('input[name="seat_number['+i+'][]"]:checked').map(function(_, el) {
                            return $(el).val();
                        }).get();

                        seat_numberArray.push(seat_number);
                ...
                $.ajax({
                    ...
                    url:"{{route('step5next')}}",
                    data: {
                        seat_number: seat_numberArray,
                        flightSeatingRoutId:flightSeatingRoutId,
                        tripDetailsId:tripDetailsId,
                    },
                    success:function(data){
                        // console.log(data);
                        ...
                        var totalPriceWithCurrency = currency + ' ' + totalPrice;
                        $('.totelFlightPrice').text(totalPriceWithCurrency);
                        // const targetTime = new Date().getTime() + 10 * 60 * 1000;
                        const targetTime = new Date().getTime() + 1 * 60 * 1000;
                            ...
                            if (timeDifference <= 0) {
                                ...
                                $.ajax({
                                    ...
                                    success:function(data){
                                        ...
                                        $('#step-6, #step6').removeClass('active show');
                                        $('#step5').addClass('active show');
                                        $('.liStep6').addClass('disabled');
                                        $('#step-5').addClass('active show');

                                        $("#step5next").attr("disabled", true);

                                        $.each(selectedSeatsArray, function(index, value) {
                                            // $('input[name="seat_number[' + index + '][]"]:checked').prop('checked', false).next('label').removeClass('seatBooked');
                                            $('input[name="seat_number[' + index + '][]"]:checked').prop('checked', false).closest('label').removeClass('seatBooked');
                                            $('input[name="seat_number[' + index + '][]"]').prop('disabled', false);

                                            $('#showTheSeat_' + index).text('');
                                        });
                                        selectedSeatsArray = [];
        ...
        $("#submitBtn").on('click', function (e) {
            $('[name=payment_method]').rules('add','required');
            if($('.checkout-form').valid()){
                // alert('aa');
            }
        });
