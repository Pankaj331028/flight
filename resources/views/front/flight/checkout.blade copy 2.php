                                                    ...
                                                    <div class="pBookHotel form-in">
                                                        ...
                                                        <div class="row px-3">
                                                            <div class="inout-control col-md-4 mb-4 position-relative">
                                                                <div class="input-group form-group mb-2 inputBorder" style="height:46px;">
                                                    ...
                                                    <div class="form-in filters-results">
                                                        ...
                                                        <div class="pBookHotel form-in">
                                                            ...
                                                            <div class="row px-3">
                                                                ...
                                                                <div class="inout-control col-md-4 mb-4 position-relative roomType">
            ...
            if($('.checkout-form').valid()){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        // $('.totelFlightPrice').text(data.totalPrice);
                        // alert('lll');
