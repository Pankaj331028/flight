...
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    ...
    <link href="{{URL::asset('/front/css/flightresponsive.css') }}" rel="stylesheet">
    ...
    <!-- <link href="{{URL::asset('/front/css/font-awesome.min.css') }}" rel="stylesheet"> -->
    <!-- <link href="https://www.omrbranch.com/front/css/font-awesome.min.css" rel="stylesheet"> -->
...
<div id="wrapper">
    ...
    <!-- ===== Top-Navigation ===== -->
    @include('front.flight.layouts.partials.navbar')
    <!-- ===== Top-Navigation-End ===== -->
    ...
    <div class="page-wrapper">
        ...
        <!--- Modals --->
        @include('front.flight.layouts.partials.modals')
        <!-- Modals end --->
    </div>
    <!-- ===== Page-Content-End ===== -->
</div>
<!-- ===== Main-Wrapper-End ===== -->
    ...
    <!--=======Required JS Files===== -->
    @include('front.flight.layouts.partials.scripts')

    <!--=======Required JS Files End===== -->
@stack('js')
</body>
    <!-- ===== Footer ===== -->
    @include('front.flight.layouts.partials.footer')
    <!-- ===== Footer-End ===== -->
