                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="footer_grid_wrapper">
                            ...
                            <div class="footer_heading mt-4">
                                <h2><span>For Joining Automation Course</span></h2>
                                <span style="color: #fff;font-size: 16px;">Please contact - Velmurugan </span><br>
                                <a href="tel:9944152058" style="color: #fff;font-size: 16px;text-decoration: underline;margin-top: 10px;display: block;">99441 52058</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
