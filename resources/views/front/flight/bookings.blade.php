...
@section('content')
						...
						<div class="tab-content">
							<div class="tab-pane active" id="bookings">
								...
								<div id="bookinglist" class="mt-3">
									@include('front.flight.all-bookinglist',['bookings'=>$bookings,'currency'=>$currency])
								</div>
							</div>
	...
	@include('front.flight.layouts.partials.partial-address-script')
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.allclearSearch').click(function(){ alert('e');
				$(this).closest('.tab-pane').find('input').val('');
				$('.allclearSearch').closest('div').addClass('d-none');
