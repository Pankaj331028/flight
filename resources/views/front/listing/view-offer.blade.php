...
<section class="wrapper2 quickGrab bgf7 py-3 py-md-5">
   <div class="container">
        <div class="sectionTitleBlock d-flex mb-5">
            ...
            @endphp
            <h5 class="sectionTitle font35 font-weight-bold color11">{{ $title }} <button id="button" type="button">Click     </button>
        </h5>
                    ...
                    <div class="col-md-4 mb-4" style="max-height: 300px;">
                        <div class="items" style="height: 100%;">
                            <div class="productImg">
                                <a href="{{ url('product/grocery/'.$product->id) }}" target="_blank"><img src="{{ $product->image }}" alt="product" height=100 data-testid="productimg"></a>
                            </div>
                            ...
                            <div class="d-flex justify-content-around">
                                ...
                                @endif
                                <p class="quantity font18 color20" id="#weight-{{ $product->product_variation_id }}">{{ $product->weight }}</p>
                            </div>
