@php
   $menus = \App\Model\AutomationMenu::get();
@endphp
<header class="header">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
               <div class="social_icons text-md-right text-center">
                  <ul class="social_top_network social-circle top_network_res">
                     ...
                     <li><a href="{{ url('user-database') }}" class="trans_btn" target="_blank">Database</a></li>
                     @endif
                     @if(in_array('admin_panel',Session::get('access')))
                     <li><a href="/admin" class="trans_btn" target="_blank">Admin Panel</a></li>
                     @endif
                     @if(in_array('sample_api',Session::get('access')))
                     <li><a href="{{ url('sample-api') }}" class="trans_btn" >Sample API</a></li>
                     @endif --}}
                     <li class="dropdown">
                        ...
                        <div class="dropdown-menu pro_display">
                           ...
                           <a class="dropdown-item padding_manage acc_anchor border-bottom {{ Request::segment(1)=='account-settings' ? 'pro_rel' : '' }}" href="{{ in_array('travel',Session::get('access')) ? url('my-bookings'):url('account-settings') }}">My Account</a>
                           @if(in_array('flight',Session::get('access')))
                           <a class="dropdown-item padding_manage acc_anchor border-bottom {{ Request::segment(1)=='flight-bookings' ? 'pro_rel' : '' }}" href="{{ url('flight-bookings') }}">Flight Bookings</a>
                           @endif
               ...
               <div class="nav_menu_wrapper">
                  <div class="collapse navbar-collapse" id="navbarResponsive">
                     <ul class="navbar-nav ml-auto custom_nav">
                        ...
                        <li class="nav-item @if(Request::segment(1)=='')active @endif">
                           <a class="nav-link" href="{{ url('/') }}"><span>Certifications</span></a>
                        </li>

                        <li class="dropdown" style="margin: 8px 8px 8px 8px;">
                        ...
                        <li class="nav-item @if(Request::segment(1)=='')active @endif">
                           <a class="nav-link" href="{{ url('/') }}"><span>Online Courses</span></a>
                        </li>

                        <li class="nav-item @if(Request::segment(1)=='')active @endif">
                           <a class="nav-link" href="{{ url('/') }}"><span>Master Program</span></a>
                        </li>
                        @if(in_array('database',Session::get('access')))
                        <li class="nav-item">
                        ...
                        @endif
                        @if(in_array('sample_api',Session::get('access')))
                        <li class="nav-item @if(Request::segment(1)=='sample-api')active @endif">
