            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
               <div class="social_icons text-md-right text-center">
                  <ul class="social_top_network social-circle top_network_res">
                     ...
                     <li><a href="https://omrbranch.com/user-database" class="trans_btn" target="_blank">Database</a></li>
                     @endif
         ...
         <div class="container">
            <div class="row justify-content-between w-100 align-items-center">
               <div class="" style="width: 100px">
                  <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ URL::asset('front/images/logo.png') }}" class="img-fluid"></a>
               </div>
               <?php
