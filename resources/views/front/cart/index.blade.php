...
@endphp
    ...
    @if(isset($usercartsitem))
        <section class="cartwrapper1 my-5">
            <div class="container">
                <h5 class="font35 font-weight-bold color11 text-center pageTitle">My Cart</h5>
        ...
        <section class="cartWarpper2">
            <div class="container borderTop1 mt-sm-5 mt-3 pt-sm-5 pt-3 px-md-0">
                ...
                <div class="row">
                    ...
                    @if(isset($user) &&  $user->user_addresses()->where('status', 'AC')->exists())
                    <div class="col-md-4">
