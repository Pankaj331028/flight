                    ...
                    <div class="content-head mb-2">
                        ...
                        <div class="favtag">
                            <p class="font20 fontsemibold mb-0">
                                <a href="javascript:void(0)" data-product="{{ $product->id }}" class="{{ $product->is_favorite==1 ? 'favdark' : '' }}" data-product="{{ $product->id }}" onclick="addToFavourite(this,{{ $product->product_variation_id }},'fav')" data-testid="favorites">
...
?>
                    ...
                    <div class="addBtn justify-content-center d-block dyna_btn_wrapper mt-2">
                     ...
                     <div class="hidden_section qtySection">
                        <div class="input_number_form input-group">
    ...
    $('.radio_btn_value').click(function(){
        ...
        $('[name^=option_value]').each(function(index,item){
            ...
            if($('[name="'+name+'"]:checked').val() == undefined){
                ...
                if($.inArray($('[name="'+name+'"]:checked').val(),ids) < 0)
        ...
        if(check){
            ...
            success: function(data){
                console.log(data);
                if(data.status == true){
                $('.qtySection').removeClass('hidden_section');
                ...
                $('.qtySection').addClass('hidden_section');
                }
