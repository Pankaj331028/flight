...
<div class="col-md-4 mb-4">
    <div class="items">
        <div class="productImg">
            <img src="{{$product->image}}" alt="" data-testid="productimg">
        </div>
        <p class="productName font16 color26 mb-1 fontsemibold text-center mt-3" data-testid="productname"> {{$product->name ?? '-'}} </p>
