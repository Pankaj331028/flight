...
@section('content')
    ...
    <section class="wrappernotification1 my-5">
        <div class="container">
            <h5 class="font35 font-weight-bold color11 text-center pageTitle">My Account</h5>
            <div class="acountTabing mt-md-5 mt-3">
                <div class="alert alert-success d-none mb-5">
                    <ul>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <div class="nav flex-sm-column nav-pills" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link font16 fontSemiBold text-capitalize @if(!Session::has('address_update'))  active @endif" id="v-pills-profile-tab"
                            ...
                            <a class="nav-link font16 fontSemiBold text-capitalize @if(Session::has('address_update')) active @endif" id="v-pills-address-tab"
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade @if(!Session::has('address_update')) show active @endif" id="v-pills-profile" role="tabpanel"
                            ...
                            <div class="tab-pane fade" id="v-pills-orders" role="tabpanel" aria-labelledby="v-pills-orders-tab">
                                ...
                                <div class="d-flex justify-content-between border-bottom pb-2 mb-3">
                                        ...
                                        <a href="javascript:;" class="font16 fontSemiBold color20 bgNone borderNone">
                                            <p class="mb-0" data-testid="{{ 'order_no'.$loop->iteration }}">Order No :<span class="font16 ml-2">{{ $item->order_no }}</span></p>
                            ...
                            <div class="tab-pane fade @if(Session::has('address_update')) show active @endif" id="v-pills-address" role="tabpanel"
                                aria-labelledby="v-pills-address-tab">

                                <button type="button" class="btn btn-primary b-2" id="remove-address" data-toggle="modal" data-target="#exampleModal">
                                     Remove Address
                                </button>
...
?>
                                            <div class="col-md-6">
                                                <div class="diffAddres mt-sm-0 mt-4 mb-3">
                                                    <div class="adresEdit d-flex align-items-center justify-content-between mb-2">
                                                        <p class="font16 fontSemiBold color20 mb-0" data-testid="address{{$key+1}}">Address {{$key+1}} </p><br>
                                                    ...
                                                    <p class="font16 color36">{{ $address }}</p>
                                                        <div class="favtag res_acc">
                                                            <p class="font16 fontsemibold mb-0">
                                                                <a data-testid="edit-address" href="javascript:void(0)" class="editAddress" data-toggle="modal" data-target="#addressModal" data-value="{{ $user_address }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="diffAddres addAddress d-flex justify-content-center align-items-center mt-sm-0 mt-4">
                                                <a href="javascript:;" data-testid="add-address">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    @include('front.modals.address')
     @if(Session::has('address_update'))
     @php
     Session::forget('address_update')
     @endphp
     @endif
@endsection
