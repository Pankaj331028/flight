...
<section class="wrapper3 topOffers py-3 py-md-5">
    <div class="container">
        <div class="sectionTitleBlock d-flex justify-content-between align-items-center mb-5">
            <h5 class="sectionTitle font35 font-weight-bold color11">Top Offers</h5>
...
<section class="wrapper5 topOffers py-3 py-md-5">
    <div class="container">
        <div class="sectionTitleBlock d-flex mb-5">
            ...
            <h5 class="sectionTitle font35 font-weight-bold color11">Categories</h5>
        </div>
        <div class="row">
            @if(isset($categories))
...
function fetchProductVariants(x){
    ...
    $.each(product.variations,function(key,variant){
        ...
        if(variant.price == variant.special_price || variant.special_price=='0'){
            var price = '<p class="font16 color20 fontsemibold mb-1 d-flex align-items-center"><span data-testid="old-price">'+currency+' '+variant.price+'</span></p>';
        }else{
            var price = '<p class="font16 color20 fontsemibold mb-1 d-flex align-items-center"><span data-testid="new-price">'+currency+' '+variant.special_price+'</span><strike class="colorb7 ml-2">'+currency+' '+variant.price+'</strike></p>'
        }

        var http = new XMLHttpRequest();
        http.open('HEAD', "{{URL::to('/')}}/".product.small_image, false);
        http.send();
        if(http.status!=404){
