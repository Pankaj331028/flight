<section class="wrapper4 render-EO bgf7 py-3 py-md-5">
    <div class="container">
        <div class="sectionTitleBlock d-flex justify-content-between align-items-center mb-5">
            <h5 class="sectionTitle font35 font-weight-bold color11">Our Exclusive Offers</h5>
            ...
            <div class="items">
                ...
                <div class="d-flex justify-content-around">
                    ...
                    @if($exclusive->price == $exclusive->special_price || $exclusive->special_price=='0')
                        <p class="price"><span class="newPrice font18 color20" data-testid="new-price">{{ $currency }}{{ $exclusive->price }}</span>
                    @else
                        <p class="price"><span class="newPrice font18 color20" data-testid="new-price">{{ $currency }}{{ $exclusive->special_price }}</span>
                            <span class="oldPrice font18 colorb7" data-testid="old-price"><strike>{{ $currency }}{{ $exclusive->price }}</strike></span>
                        </p>
                    @endif
                ...
                <div class="favtag">
                    <p class="font20 fontsemibold mb-0">
                        <a class="{{ $exclusive->is_favorite==1 ? 'favdark' : '' }}" href="javascript:void(0)" data-product="{{ $exclusive->id }}" onclick="addToFavourite(this,{{ $exclusive->variations[0]->id }},'fav')" data-testid="favorites">
