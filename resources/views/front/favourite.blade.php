...
<section class="wrapper2 quickGrab bgf7 py-3 py-md-5">
    <div class="container">
        <div class="sectionTitleBlock d-flex mb-5">
            <h5 class="sectionTitle font35 font-weight-bold color11">Favorites</h5>
        </div>
                ...
                <div class="items" style="height: 100%;">
                    ...
                    <div class="favtag">
                        <p class="font20 fontsemibold mb-0">
                            <a href="javascript:void(0)" class="favdark" data-product="{{ $product->id }}" onclick="addToFavourite(this,{{ $product->product_variation_id }},'fav')" data-testid="favorites">
