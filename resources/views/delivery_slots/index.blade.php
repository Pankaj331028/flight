	...
	<div class="content-wrapper">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">Delivery Slots</h3> </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Delivery Slots</h4>

                        @if (Helper::checkAccess(route('createDeliverySlot')))
                            <div class="dt-buttons float-right">
                                <a href="{{route('createDeliverySlot')}}" class="btn dt-button py-2">Add Delivery Slot</a>
                            </div>
                        @endif
                        <div class="table-responsive m-t-40">
                            ...
                            @if (Helper::checkAccess(route('changeStatusDeliverySlots')))
                                <div class="dt-buttons">
                                    <a href="javascript:void(0)" data-href="{{route('changeStatusDeliverySlots')}}" class="btn btn-secondary disabled bulkAction changeStatusDeliverySlots">Activate/Deactivate</a>
                                </div>
                            @endif
                            <table id="deliverySlotTable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-valide" method="post" id="blockForm" action="{{route('changeStatusDeliverySlot')}}">
                        {{csrf_field()}}
...
@push('scripts')
    ...
    <script type="text/javascript">
    	$(function(){
    		var table = $('#deliverySlotTable').DataTable({
                "ajax": {
                    url:"{{route('deliverySlotsAjax')}}",
                    dataSrc:"data",
                    data:{
                        from_date: $('input[name=from_date]').val(),
                        end_date: $('input[name=end_date]').val(),
                        status: $('select[name=status]').val(),
                        slot_type: $('select[name=slot_type]').val(),
                        slot_day: $('select[name=slot_day]').val(),
                    }
                    // type: "get"
                },
                paging: true,
                ...
                @if(Helper::checkAccess('admin/delivery_slots/report'))
		        dom: 'Bfrtip',
                buttons: [
            ...
            $(document).on('click','input[name="user_ids[]"]',function(){
                ...
                if(length > 0)
                {
                    $('.changeStatusDeliverySlots').removeClass('disabled');
                    table.rows().select();
                }
                else{
                    $('.changeStatusDeliverySlots').addClass('disabled');
                    table.rows().deselect();
                }
            });
            ...
            $(document).on('switchChange.bootstrapSwitch', '.statusDeliverySlot', function (event, state) {
                var x;
                ...
                $.ajax({
                    type: "post",
                    url: "{{route('changeStatusAjaxDeliverySlot')}}",
                    ...
                    error: function(data)
                    {
                        ...
                        toastr.error("Unable to update slot.","Status",{
                            timeOut: 5000,
                            "closeButton": true,
                            "debug": false,
                            "newestOnTop": true,
            ...
            $('.deleteDeliverySlot').click(function(){
                var id = $(this).data('id');
            ...
            $('.bulkAction').click(function(){
                ...
                $.ajax({
                    ...
                    error: function(data)
                    {
                        ...
                        toastr.error("Unable to update slots.","Status",{
                            timeOut: 5000,
                            "closeButton": true,
                            "debug": false,
                            "newestOnTop": true,
