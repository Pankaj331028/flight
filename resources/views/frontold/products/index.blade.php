...
<section class="wrapper2 quickGrab bgf7 py-3 py-md-5">
    <div class="container">
        <div class="sectionTitleBlock d-flex mb-5">
            <div class="sectionTitle font35 font-weight-bold color11">{{ isset($category) ? ucfirst($category->name) : 'Product' }}</div>
            ...
            <div class="col-md-4 mb-4" style="max-height: 300px;">
                    <div class="items" style="height: 100%;">
                        <div class="productImg">
                            <a href="{{ url('product/grocery/'.$product->id) }}" target="_blank"><img src="{{$product->image}}" alt="product" height=100></a>
                        </div>
