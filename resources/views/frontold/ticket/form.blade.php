        ...
        <div class="modal-body">
            <form method="POST" action="{{ url('api/ticketSubmit') }}" id="form" class="ticketGenerate">
                ...
                <div class="send_otp_div" id="send_otp_div">
                    <iframe src="{{URL::asset('ticketGenerateOtp')}}" title="" id="frameDemo">
                    </iframe>
                </div>
...
$('#send_otp').on('click', function(){
    ...
    success: function(result){
        ...
        $( "#frameDemo" ).contents().find("input[name='otp_data']").val('');
        $( "#frameDemo" ).contents().find("input[name='otp_data']").val(result.otp);
        var otp = $( "#frameDemo" ).contents().find("input[name='otp_data']").val();
        $("input[name='otp']").val('');
...
$('#frameDemo').contents().change(function(){
    var otp = $( "#frameDemo" ).contents().find("input[name='otp_data']").val()
    $("input[name='otp']").val('');
    $("input[name='otp']").val(otp);
  });
