                        ...
                        <div class="tab-pane active" id="profile" role="tabpanel">
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div class="col-md-4 columns">
                                        <h6 class="p-t-20">Delivery Address</h6>
                                        @if(isset($order->user_address->id))
                                        <small class="text-primary font-15 db">{{$order->user_address->first_name . " " . $order->user_address->last_name . ", " . $order->user_address->apartment . ", " . $order->user_address->address . ", " . $order->user_address->acity->name . ", " . $order->user_address->astate->name . ", " . $order->user_address->acountry->name . "- " . $order->user_address->zipcode}}</small>
                                        @else
                                        <small class="text-primary font-15 db">-</small>
                                        @endif
                                    </div>
                                    <div class="col-md-4 columns">
                                    ...
                                    <table id="ordersTable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($order->order_items as $value)
                                                <tr>
                                                    <td>{{$i++}}</td>
                                                    <td>{{$value->product_items->name}}</td>
                                                    <td>{{$value->qty}}</td>
                                                    <td>{{$value->price}}</td>
