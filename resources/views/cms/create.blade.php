...
@section('content')
    ...
    <div id="dummyRow" style="display: none;">
        <div class="faqRow" id="row_0">
            ...
            @elseif($cms['slug']=='delivery-faq')
                <input type="hidden" name="faqtype_0" value="delivery-faq">
            @endif
            <div class="row">
                ...
                <input type="hidden" name="faqstatus_0" value="AC">
        ...
        $(function(){
            ...
            if(count==0){
                ...
                @foreach($faqs as $value)
                    ...
                    $('#faqs').find('input[name=val-faqstatus_'+row+']').bootstrapSwitch('state', "{{$value->status}}" == 'AC' ? true:false, false);
                    if(!state){
            ...
            $(document).on('click','.deleteRow',function(){
                ...
                $('#faqs .faqRow').each(function(index,elem){
                    ...
                    addRules(count);
                    var state= (faqstatus == 'AC') ? true:false;
            ...
            $(document).on('switchChange.bootstrapSwitch', 'input[name^=val-faqstatus]', function (event, state) {
                ...
                if($(this).is(':checked'))
                    $('input[name=faqstatus_'+id+']').val('AC');
                else
                    $('input[name=faqstatus_'+id+']').val('IN');
            });
