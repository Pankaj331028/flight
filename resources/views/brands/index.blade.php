...
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if (Helper::checkAccess(route('createBrand')))
                            <div class="dt-buttons float-right">
                                <a href="{{route('createBrand')}}" class="btn dt-button py-2">Add Brand</a>
                            </div>
                        @endif
                        <div class="table-responsive m-t-40">
                            @if (Helper::checkAccess(route('deleteBrands')))
                            ...
                            @endif
                            @if (Helper::checkAccess(route('changeStatusBrands')))
                                <div class="dt-buttons">
    ...
    <div class="modal fade" id="brandstatusModal" tabindex="-1" role="dialog" aria-labelledby="brandstatusModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="brandstatusModalLabel">Confirm</h5>
                ...
                <div class="modal-body">
                    <form class="form-valide" method="post" id="blockForm" action="{{route('changeStatusBrand')}}">
                        ...
                        <h5 class="m-t-10 text-danger">Are you sure you want to <span class="brandstatus"></span> brand : <span id="statuscode"></span></h5>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-valide" method="post" id="deleteForm" action="{{route('deleteBrand')}}">
                        ...
                        <h5 class="m-t-10 text-danger">Are you sure you want to delete brand : <span id="val-code"></span></h5>
                        <button type="button" class="btn btn-secondary btn-flat cancelBtn m-b-30 m-t-30" data-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-info btn-flat confirmBtn m-b-30 m-t-30">Confirm</button>
                    </form>
                </div>
    ...
    <script type="text/javascript">
        $(function(){
            var table = $('#brandsTable').DataTable({
                ...
                @if(Helper::checkAccess('admin/brands/report'))
                dom: 'Bfrtip',
                buttons: [
            ...
            $(document).on('switchChange.bootstrapSwitch', '.statusBrand', function (event, state) {
                ...
                $.ajax({
                    ...
                    error: function(data)
                    {
                        ...
                        toastr.error("Unable to update brand.","Status",{
                            timeOut: 5000,
                            "closeButton": true,
                            "debug": false,
                            "newestOnTop": true,
