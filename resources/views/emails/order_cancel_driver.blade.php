	...
	<table width="800" cellspacing="0" style="border:1px solid #40b851; border-radius:5px; overflow:hidden">
		...
		<tr>
			<td style="text-align:left; padding:10px 0px 20px 20px;" bgcolor="#f9f9f9">
				...
				<div style="margin:20px auto 10px; font-size:15px;">Order #: {{$order->order_no}} has been cancelled  @if(isset($date)) for date {{date('d M, Y', strtotime($date))}} @endif. Do not deliver this order</div>
			</td>
		</tr>
		<tr>
