		...
		<tr>
			<td style="text-align:left; padding:10px 0px 20px 20px; " bgcolor="#f9f9f9">
                ...
                <div style="margin:20px auto 10px;">
                    <p style="font-size: 16px;color: #5f5e5e;line-height: 1.5;margin-top: 10px;">Congratulations! your account has been approved. <br> Kindly log in to <a href="{{ config('app.url') }}" style="color : #40b851;font-weight:bold;">omrbranch App </a> to continue browsing. You can also use API Key: <strong>{{$api_key}}</strong> to login via Swagger API.</p>
                </div>
			</td>
		</tr>
		<tr>
