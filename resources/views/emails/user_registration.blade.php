	...
	<table width="800" cellspacing="0" style="border:1px solid #40b851; border-radius:5px; overflow:hidden">
		...
		<tr>
			<td style="text-align:left; padding:10px 0px 20px 20px; " bgcolor="#f9f9f9">
                ...
                <div style="margin:20px auto 10px; font-size:16px;">Thank you for signing up with <span style="color : #40b851;">OMRBRANCH </div>
                @if(isset($verify_link))
                <div style="margin:20px auto 10px;">
                <p style="margin:10px auto 10px;">Just one more step to go… Click below link to verify your account.</p>
                <p><a href="{{$verify_link}}" style="color : #40b851;font-weight:bold;">{{ $verify_link }}</a></p>
                </div>
                @endif
			</td>
		</tr>
