    ...
    success: function(res)
    {
        ...
        if(res.status==200){
            ...
            // if(res.message=='Product removed successfully'){
                ...
                window.location.replace("https://velsbusinessclub.vlcare.com/my-cart");
                // window.location.replace("http://127.0.0.1:8000/my-cart");
