                           ...
                           <div class="cart_innerbox" id="cart_popup">
                              ...
                              <div class="row cart_innerbox_main" id="cart_innerbox_main">
                                 <div class="col-12">
                                    ...
                                    @php
                                    $str = substr($item->product_image, strpos($item->product_image, 'uploads'));
                                    if (File::exists($str)) {
         ...
         <div class="col-lg-6">
            <div class="social_icons text-right">
               <ul class="social_top_network social-circle">
                  ...
                  --}}
                  <li>
                     <a href="#" class="icoLinkedin colorTheme mr-2 btn-modal" data-toggle="modal" data-target="#loginSignupModal" data-tab="login"> Login</a>
                     <span>|</span>
                     <a href="#" class="icoLinkedin btn-modal" data-toggle="modal" data-target="#loginSignupModal" data-tab="register"> Sign up</a>
                  </li>
                  <li><a href="#" data-tab="login" data-toggle="modal" data-target="#loginSignupModal" class="icoTwitter mr-2 btn-modal"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a></li>
               </ul>
            </div>
         </div>
         @endif
